...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.btn_delete, 1, 2, 1, 1)
        self.table_input = QtWidgets.QTableWidget(self.groupBox_6)
        self.table_input.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.table_input.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 838, 305))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.scrollAreaWidgetContents)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.grpb_cut = QtWidgets.QGroupBox(self.scrollAreaWidgetContents)
        self.grpb_cut.setCheckable(True)
        self.grpb_cut.setChecked(False)
        self.grpb_cut.setObjectName("grpb_cut")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.grpb_cut)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.gridLayout_4 = QtWidgets.QGridLayout()
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.time_to = QtWidgets.QTimeEdit(self.grpb_cut)
        self.time_to.setCurrentSection(QtWidgets.QDateTimeEdit.HourSection)
        self.time_to.setObjectName("time_to")
        self.gridLayout_4.addWidget(self.time_to, 1, 1, 1, 1)
        self.time_start = QtWidgets.QTimeEdit(self.grpb_cut)
        self.time_start.setCurrentSection(QtWidgets.QDateTimeEdit.HourSection)
        self.time_start.setObjectName("time_start")
        self.gridLayout_4.addWidget(self.time_start, 0, 1, 1, 1)
        self.label_10 = QtWidgets.QLabel(self.grpb_cut)
        self.label_10.setObjectName("label_10")
        self.gridLayout_4.addWidget(self.label_10, 1, 0, 1, 1)
        self.label_9 = QtWidgets.QLabel(self.grpb_cut)
        self.label_9.setObjectName("label_9")
        self.gridLayout_4.addWidget(self.label_9, 0, 0, 1, 1)
        self.gridLayout_10.addLayout(self.gridLayout_4, 0, 0, 1, 1)
        self.gridLayout_7.addWidget(self.grpb_cut, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.grpb_cut.setTitle(_translate("MainWindow", "裁剪"))
        self.time_to.setDisplayFormat(_translate("MainWindow", "H:mm:ss"))
        self.time_start.setDisplayFormat(_translate("MainWindow", "H:mm:ss"))
