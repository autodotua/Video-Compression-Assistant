...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.gpb_file)
        ...
        self.gridLayout_4.addWidget(self.chk_image_seq, 0, 0, 1, 1)
        self.chk_force_ext = QtWidgets.QCheckBox(self.gpb_file)
        self.chk_force_ext.setObjectName("chk_force_ext")
        self.gridLayout_4.addWidget(self.chk_force_ext, 1, 0, 1, 1)
