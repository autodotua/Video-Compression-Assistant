...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_2 = QtWidgets.QFormLayout(self.gpb_file)
        ...
        self.chk_cut.setText("")
        self.chk_cut.setObjectName("chk_cut")
        self.horizontalLayout_5.addWidget(self.chk_cut)
        self.label_21 = QtWidgets.QLabel(self.gpb_file)
        self.label_21.setObjectName("label_21")
        self.horizontalLayout_5.addWidget(self.label_21)
        self.formLayout_2.setLayout(2, QtWidgets.QFormLayout.LabelRole, self.horizontalLayout_5)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 817, 305))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_21.setText(_translate("MainWindow", "裁剪："))
